...
st.set_page_config(page_title="Chart Bot Agent", layout="wide")
session_cache = {
    "logo_path": None,
    "image_path": None,
    "csv_path": None,
...
st.markdown("<h3 style='font-family:Arial; color:#333;'>chart bot assistant</h3>", unsafe_allow_html=True)
...
with st.container():
    ...
    if query:
        with st.spinner("Analyzing..."):
            ...
            result = asyncio.run(run_manager_agent(query=query, path=file_path))
